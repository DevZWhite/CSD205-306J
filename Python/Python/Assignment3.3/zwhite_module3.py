...
def get_initial_investment():
    ...
    while True:
        try:
            ...
            # If the conversion fails, print an error message and the loop continues back to line 27'
...
def get_interest_rate():
    ...
    while True:
        try:
            ...
            # If the conversion fails, print an error message and the loop continues back to line 40
            print(f"Error: {user_input} invalid, please try again.")
